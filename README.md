[![Build Status](https://travis-ci.org/frmanager/fr-webapp-admin.svg?branch=test)](https://travis-ci.org/frmanager/fr-webapp-admin) [![Quality Status](https://sonarcloud.io/api/badges/gate?key=fr-webapp-admin:test)](https://sonarcloud.io/dashboard?id=fr-webapp-admin:test)
