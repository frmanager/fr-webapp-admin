 ...
 *
 * @Route("/manage/{campaignUrl}/awards")
 */
class ManageCampaignawardController extends Controller
{
    /**
    ...
    public function indexAction($campaignUrl)
    {
        ...
        return $this->render('campaignManager/campaignAward.index.html.twig', array(
    ...
    public function showAction(Campaignaward $campaignaward, $campaignUrl)
    {
        ...
        return $this->render(strtolower($entity).'campaignManager/campaignAward.show.html.twig', array(
            'campaignaward' => $campaignaward,
