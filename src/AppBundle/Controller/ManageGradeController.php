 ...
 *
 * @Route("/manage/{campaignUrl}/grades")
 */
class ManageGradeController extends Controller
{
    ...
    public function indexAction($campaignUrl)
    {
        ...
        return $this->render('campaignManager/grade.index.html.twig', array(
            'grades' => $grades,
            'entity' => $entity,
     ...
     *
     * @Route("/new", name="manageGrade_new")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{id}", name="manageGrade_show")
     * @Method("GET")
     */
    public function showAction(Grade $grade, $campaignUrl)
    {
        ...
        return $this->render('campaignManager/grade.show.html.twig', array(
            'grade' => $grade,
     ...
     *
     * @Route("/edit/{id}", name="manageGrade_edit")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/delete/{id}", name="manageGrade_delete")
     * @Method("DELETE")
     */
