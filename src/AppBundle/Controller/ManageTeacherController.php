...
class ManageTeacherController extends Controller
{
   ...
   *
   * @Route("/", name="manageTeacher_index")
   * @Method({"GET", "POST"})
   */
  public function teacherIndexAction($campaignUrl)
  {
     ...
     *
     * @Route("/new", name="manageTeacher_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request, $campaignUrl)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('manageTeacher_index', array('id' => $teacher->getId()));
        }
     ...
     *
     * @Route("/{id}", name="manageTeacher_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/edit/{id}", name="manageTeacher_edit")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/delete/{id}", name="manageTeacher_delete")
     * @Method("DELETE")
     */
     ...
     * Creates a new Teacher entity.
     *
     * @Route("/upload", name="manageTeacher_upload")
     * @Method({"GET", "POST"})
     */
