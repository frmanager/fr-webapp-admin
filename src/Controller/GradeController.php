...
class GradeController extends Controller
{
    ...
    public function indexAction($campaignUrl, LoggerInterface $logger)
    {
        ...
        $grades = $em->getRepository('App:Grade')->findByCampaign($campaign);
     ...
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, $campaignUrl, $gradeId, LoggerInterface $logger)
    {
        ...
        $grade = $em->getRepository('App:Grade')->find($gradeId);
        if(is_null($grade)){
     ...
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Grade $grade, $campaignUrl, LoggerInterface $logger)
    {
        $entity = 'Grade';
