...
class InvitationController extends Controller
{
    ...
    public function indexAction(LoggerInterface $logger)
    {
        ...
        $invitations = $em->getRepository('App:Invitation')->findAll();
    ...
    public function newAction(Request $request, LoggerInterface $logger)
    {
        ...
        $form = $this->createForm('App\Form\InvitationType', $invitation);
     ...
     * @Method("GET")
     */
    public function showAction(Invitation $invitation, LoggerInterface $logger)
    {
        $entity = 'Invitation';
     ...
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Invitation $invitation, LoggerInterface $logger)
    {
        $entity = 'Invitation';
